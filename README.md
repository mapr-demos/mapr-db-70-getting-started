...
* MapR Converged Data Platform 7.0 with Apache Drill or [MapR Container for Developers](https://docs.datafabric.hpe.com/70/MapRContainerDevelopers/MapRContainerDevelopersOverview.html).
* JDK 8
* Maven 3.x
